...
$(document).on("mouseenter", ".item-slot", function(e) {
    ...
    if ($(this).data("item") != null) {
        ...
        $(".ply-iteminfo-container1").fadeIn(150);
        FormatItemInfo($(this).data("item"));
    } else {
        $(".ply-iteminfo-container").fadeOut(100);
        $(".ply-iteminfo-container1").fadeOut(100);
    }
});
...
$(".clothing").click((e) => {
    $.post("https://qb-inventory/changeClothes", JSON.stringify({ clothing: e.target.id }));
});
            ...
            if (ItemData.name.split("_")[0] == "weapon") {
                if (!$("#weapon-attachments").length) {
                    $(".inv-options-list").append(
                        '<div class="inv-option-item" id="weapon-attachments"></div>'
                    );
...
function FormatAttachmentInfo(data) {
    $.post("https://qb-inventory/GetWeaponData", JSON.stringify({
        ...
        $(".weapon-attachments-container-details").html('<span style="font-weight: bold; letter-spacing: .1vh;">Serial</span><br> ' + ClickedItemData.info.serie + '<br><br><span style="font-weight: bold; letter-spacing: .1vh;">Origen</span><br> ' + (ClickedItemData.info.origen && ClickedItemData.info.origen || "Desconocido") + '<br><br><span style="font-weight: bold; letter-spacing: .1vh;">Estado - ' + Durability.toFixed() + '% </span> <div class="weapon-attachments-container-detail-durability"><div class="weapon-attachments-container-detail-durability-total"></div></div>')
        ...
        if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
            if (data.AttachmentData.length > 0) {
                ...
                $(".weapon-attachments-title").html(
                    '<span style="font-weight: bold; letter-spacing: .1vh;">Este arma no contiene complementos</span>'
                );
            }
        } else {
            $(".weapon-attachments-title").html(
                ...
                function(data) {
                    if (data.Attachments !== null && data.Attachments !== undefined) {
                        if (data.Attachments.length > 0) {
                            ...
                            $(".weapon-attachments-title").html(
                                '<span style="font-weight: bold; letter-spacing: .1vh;">Esta pistola no contiene accesorios</span>'
                            );
                        }
                    } else {
                        $("#weapon-attachment-" + AttachmentDraggingData.id).fadeOut(
...
$(document).on("click", "#weapon-attachments", function(e) {
    ...
    if (!Inventory.IsWeaponBlocked(ClickedItemData.name)) {
        ...
        $.post(
            ...
            JSON.stringify({
                message: "No hay complementos disponibles para este arma",
                type: "error",
            })
        );
    }
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Nombre: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Apellido: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Fecha de nacimiento: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Genero: </strong><span>" +
                gender +
                "</span></p><p><strong>Nacionalidad: </strong><span>" +
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Fecha de nacimiento: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Licencias: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Identificador: </strong><span>" +
                itemData.info.id +
                "</span></p><p><strong>Nombre: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Apellido: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p>" + itemData.info.uses + " usa a la izquierda.</p>"
            );
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html(
                    ...
                    itemData.info.ammo +
                    "</span></p><p><strong>Complementos: </strong><span>" +
                    attachmentString +
                    "</span></p>"
                );
            } else {
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    "<p><strong>Material de la evidencia: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Número: </strong><span>" +
                    itemData.info.ammotype +
                    "</span></p><p><strong>Calibre: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Serial: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Escena del crimen: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Material de la evidencia: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Tipo de sangre: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Material de la evidencia: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Huella dactilar: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Cantidad de dinero: </strong><span>$" +
                itemData.info.cash +
                "</span></p>"
            );
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>Titular: </strong><span>' + itemData.info.name + '</span></p><p><strong>ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Número de tarjeta: </strong><span>' + cardNumber + '</span></p>');			
...
function handleDragDrop() {
    $(".item-drag").draggable({
        ...
        start: function(event, ui) {
            ...
            $(".item-slot").css("border", "0.05vh solid rgb(9,167,167)");
            var itemData = $(this).data("item");
            var dragAmount = $("#item-amount").val();
            if (!itemData.useable) {
                $("#item-use").css("background", "rgba(35,35,35, 0");
            }
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $(".ply-iteminfo-container1").css("display", "none");
    ...
    window.onload = function(e) {
        window.addEventListener("message", function(event) {
            switch (event.data.action) {
                ...
                case "RobMoney":
                    $(".inv-options-list").append(
                        '<div class="inv-option-item-steal" id="rob-money"><p>Steal cash</p></div>'
                    );
